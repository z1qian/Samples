...
internal class BindingHelper
{
    ...
    /// </summary>
    /// <param name="httpContext">请求的HttpContext对象</param>
    /// <param name="actionMethod">操作方法的MethodInfo对象</param>
    /// <returns></returns>
    /// <exception cref="Exception">Action参数只能为0或1个</exception>
